...
{
    public partial class SNDContext : DbContext
    {
        public SNDContext()
        {
        }

        public SNDContext(DbContextOptions<SNDContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer("data source=PROGRAMACION-3\\NAVDEMO;initial catalog=SND;user id=sa;password=Fasan1;");
            }
        }
